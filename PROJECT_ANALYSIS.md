# تحليل شامل لمشروع Uni-Shop (متجر يونى شوب الإلكتروني) - بنية Clean Architecture

مرحباً بك! يهدف هذا الملف إلى تقديم تحليل هيكلي وتقني مفصل ومكامل لمشروع **Uni-Shop**، وهو عبارة عن منصة تجارة إلكترونية متكاملة مصممة خصيصاً للتجارة الإلكترونية في مصر. تم بناء المشروع بالاعتماد على نمط **البنية النظيفة (Clean Architecture)** مقسماً إلى 5 مشاريع فرعية باستخدام بيئة عمل **ASP.NET Core 9.0 MVC / Web API** مع نظام **Entity Framework Core 9.0** وقاعدة بيانات **SQL Server**.
