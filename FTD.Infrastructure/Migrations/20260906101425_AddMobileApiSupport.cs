...
{
    /// <inheritdoc />
    public partial class AddMobileApiSupport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // MANUAL EDIT: the scaffolded default was DateTime.MinValue (0001-01-01),
            // which would stamp every pre-existing account with a nonsensical
            // creation date. GETUTCDATE() records the migration instant instead —
            // the closest truthful value available for legacy rows — so
            // "member since" displays stay sane.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppVersion = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestHash = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplacedByHash = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_UserId_CreatedAt",
                table: "SalesOrders",
